...
if ( ! function_exists( 'add_theme_support' ) ) {
	...
	function developry_theme_support() {
		...
		if ( ! empty( $theme_options['bootstrap_theme'] )
			...
			add_editor_style( 'https://stackpath.bootstrapcdn.com/bootswatch/4.1.1/' . $theme_options['bootstrap_theme'] . '/bootstrap.min.css' );
		} else {
		...
		add_editor_style( get_template_directory_uri() . '/assets/css/extend/admin.min.css' );
		...
		add_theme_support( 'custom-header',
			array(
				...
				'default-image' => get_template_directory_uri() . '/assets/img/blank.jpg',
				'width'         => 2000,
				'height'        => 1200,
				'uploads'       => true,
				'flex-width'    => true,
