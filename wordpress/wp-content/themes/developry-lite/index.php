<?php
/**
 * Template displaying blog posts content with pagination.
 *
 * @package Developry
...
<div id="body" class="body <?php print ( ! empty( $theme_options['featured_image'] ) && 'show' === $theme_options['featured_image'] ) ? 'm:360' : ''; ?>">
